...
public class AutoConfigDataSource {
    ...
    public static final  String APP_SECRET = "76Y7kHp3OFR2Twwzgo";
	...
	public DruidDataSource dataSource() throws Exception {
		...
		dataSource.setPassword(SystemEncoder.AESDncode(APP_SECRET,properties.getPassword()));
